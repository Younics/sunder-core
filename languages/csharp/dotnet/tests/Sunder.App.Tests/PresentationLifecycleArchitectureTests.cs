...
public sealed class PresentationLifecycleArchitectureTests
{
    ...
    {
        var views = Path.Combine(GetRepositoryRoot(), "languages", "csharp", "dotnet", "host", "Sunder.App", "Views");
    ...
    {
        var path = Path.Combine(GetRepositoryRoot(), "languages", "csharp", "dotnet", "host", "Sunder.App", "Services", "WindowLauncher.cs");
    ...
    {
        var directory = Path.Combine(GetRepositoryRoot(), "languages", "csharp", "dotnet", "host", "Sunder.App", "ViewModels");
    ...
    {
        var path = Path.Combine(GetRepositoryRoot(), "languages", "csharp", "dotnet", "host", "Sunder.App", "Views", "MainWindow.axaml.cs");
        var source = File.ReadAllText(path);
    ...
    {
        var services = Path.Combine(GetRepositoryRoot(), "languages", "csharp", "dotnet", "host", "Sunder.App", "Services");
    ...
    public void RuntimeClientInterface_DoesNotExposeRemovedSessionApplicationSwitchesOrPathHandles()
    {
        var source = File.ReadAllText(Path.Combine(
            GetRepositoryRoot(), "languages", "csharp", "dotnet", "host", "Sunder.App", "Services", "IRuntimeApiClient.cs"));
    ...
    {
        var services = Path.Combine(GetRepositoryRoot(), "languages", "csharp", "dotnet", "host", "Sunder.App", "Services");
        var appDirectory = Path.Combine(GetRepositoryRoot(), "languages", "csharp", "dotnet", "host", "Sunder.App");
        ...
        var testDirectory = Path.Combine(GetRepositoryRoot(), "languages", "csharp", "dotnet", "tests", "Sunder.App.Tests");
