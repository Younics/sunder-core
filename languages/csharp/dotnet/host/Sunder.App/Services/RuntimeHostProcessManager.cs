...
public sealed class RuntimeHostProcessManager : IDisposable
{
    ...
    public RuntimeHostProcessManager(AppStartupOptions startupOptions)
        : this(startupOptions, runtimeConnectionState: null, resolveRuntimeHostPath: null)
    {
    }
    ...
    public RuntimeHostProcessManager(
        ...
        : this(startupOptions, runtimeConnectionState, resolveRuntimeHostPath: null)
    {
    }
    ...
    private string? ResolveRuntimeHostPath()
        => ResolveRuntimeHostPath(_startupOptions.RuntimeHostPath, AppContext.BaseDirectory);

    internal static string? ResolveRuntimeHostPath(string? configuredPath, string baseDirectory)
        => ResolveFromPath(configuredPath)
