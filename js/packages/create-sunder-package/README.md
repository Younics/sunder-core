...
Run `npm create sunder-package@latest` to scaffold a TypeScript Node `process` Runtime package. Add `-- --template react-node` for a combined hosted web App target and full-trust pinned Node SEA Runtime target.
